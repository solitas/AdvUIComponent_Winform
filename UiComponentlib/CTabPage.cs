...
{
	[ToolboxItem(false)]
	[Designer(typeof(CTabPageDesigner))]
	public class CTabPage : ContainerControl
	{
		...
		{
			return new CTabPage.ControlCollection(this);
		}
