...
namespace Rootech.UI.Component
{
    public class ComponentVisualization
    {
        ...
        private ComponentVisualization()
        {
            ...
            ROBOTO_REGULAR_9 = new Font(GetFontFamilyByResource(Resources.Roboto_Regular), 8f);
            ROBOTO_REGULAR_10 = new Font(GetFontFamilyByResource(Resources.Roboto_Regular), 10f);
